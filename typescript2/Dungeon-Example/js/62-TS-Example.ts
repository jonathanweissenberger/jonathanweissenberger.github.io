...
function generateMonster()
{
   ...
   //console.log(monsterArray[monsterArray.length-1]); // Fehler gefunden  No2 Funktion              // Man kann nur auf Array-Teile zugreifen, welche definiert sind. -1 ist nicht definitiert (und wird es auch nie sein).
...
function monsterGenerateHTML()
{
    ...
    monsterArmor.innerHTML = "Rüstung: "+ monsterArray[monsterArray.length - 1].monsterArmor;
